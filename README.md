...
- Make
- [SDL2](https://www.libsdl.org/), [SDL2_image](https://github.com/libsdl-org/SDL_image), and [SDL2_ttf](https://github.com/libsdl-org/SDL_ttf)
...
**Linux:** Install `libsdl2-dev`, `libsdl2-image-dev`, and `libsdl2-ttf-dev` (e.g. `apt install libsdl2-dev libsdl2-image-dev libsdl2-ttf-dev`).
